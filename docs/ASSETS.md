...
| `docs/branding/voxelens-studio-logo.png` | A 1024 × 1024 opaque avatar rendered from the same application geometry with `tools/Generate-AppIcon.ps1 -Avatar -OutputDirectory docs/branding`. Used in the README and as a community avatar. The same Lucide/Feather notices apply. |
